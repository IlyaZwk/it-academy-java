        ...
        if (Objects.equals(choose, "sms")) {
            ...
            Thread thread2 = new Thread(() -> {
                ...
                try {
                    ...
                    System.out.println("Dmitry got message from " + user1.getNumber() + ", message: " + message + ", time the message was sent: " + time1);
                } catch (InterruptedException ignored) {
                }
            });
            ...
            Thread thread2 = new Thread(() -> {
                ...
                try {
                    message = exchanger.exchange("Hello from " + user2.getName());
                    System.out.println("Dmitry got message from " + user1.getMail() + ", message: " + message + ", time the message was sent: " + time1);
                } catch (InterruptedException ignored) {
                }
            });
